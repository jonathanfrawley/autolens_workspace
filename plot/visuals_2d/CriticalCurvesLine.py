...
"""The `Tracer` includes its critical_curves as an internal property, meaning we can plot them via an `Include2D` object."""
...
visuals_2d = aplt.Visuals2D(critical_curves=tracer.critical_curves)
