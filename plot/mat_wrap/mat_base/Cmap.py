...
"""
In this example, we illustrate how to customize the Colormap in PyAutoLens figures and subplots.
...
"""
We can customize the colormap using the `Cmap` `mat_obj` in PyAutoLens . 
...
plotter = aplt.Plotter(cmap=cmap)
...
cmap = aplt.Cmap(
    cmap="bgy", norm="symmetric_log", vmin=0.0, vmax=1.0, linthresh=0.05, linscale=0.1
)
