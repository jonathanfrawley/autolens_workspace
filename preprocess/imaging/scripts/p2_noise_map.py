...
# aplt.ArrayPlotter(array=noise_map_processed)

# %%
"""
__Noise Conversions__
There are many different ways the noise-map can be reduced. We are aiming to include_2d conversion functions for all 
...
aplt.ArrayPlotter(array=weight_map)
